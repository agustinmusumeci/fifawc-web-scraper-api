...
class StadiumsRepository {
  async getStadiums(): Promise<Array<{ stadium: string }>> {
    ...
    const matchesData: any = await scraper.scrape("https://www.fifa.com/en/tournaments/mens/worldcup/canadamexicousa2026/scores-fixtures?wtw-filter=ALL", ".match-row_matchRowContainer__NoCRI", {});
